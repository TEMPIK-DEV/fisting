...
C='\033[0m' #CLEAR
N = '\x1b[0m' # WARNA MATI
USN="Mozilla/5.0 (Linux; Android 8.0.0; Mi A1 Build/OPR1.170623.026; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/65.0.3325.109 Mobile Safari/537.36 Instagram 40.0.0.14.95 Android (26/8.0.0; 408dpi; 1080x1920; Xiaomi/xiaomi; Mi A1; tissot_sprout; qcom; ru_RU; 102221279)"
    ...
    def checkAPI(self,user,pw):
        try:
            ...
            s.headers.update({
                ...
                'x-ig-www-claim': 'hmac.AR3foTCqhsda0-2DQItRhHxVAZl4TkvBKKePwnw7rlHS7TPs',
